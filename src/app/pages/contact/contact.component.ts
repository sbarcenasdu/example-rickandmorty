        ...
        >
          <div>
            ...
            @if(contactForm.get('email')?.invalid && contactForm.get('email')?.touched){
              <p class="text-orange-400 text-sm">Correo obligatorio</p>
            }
            @if(contactForm.get('email')?.errors?.['email']){
              <p class="text-orange-400 text-sm">Correo no válido</p>
            }
          </div>
          <div>
            <label
          ...
          <div class="sm:col-span-2">
            ...
            @if(messageField.invalid && messageField.touched){
              <p class="text-orange-400 text-sm">Mensaje obligatorio</p>
            }
